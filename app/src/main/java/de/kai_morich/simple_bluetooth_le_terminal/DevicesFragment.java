...
public class DevicesFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*SwipeRefreshLayout refreshLayout= (SwipeRefreshLayout) getActivity().findViewById(R.id.swipe);
        // Mengeset listener yang akan dijalankan saat layar di refresh/swipe
        refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                onResume();
                // Handler untuk menjalankan jeda selama 1 detik
...
//        View view = inflater.inflate(R.layout.device_list_header, container, false);
//
...
//        activity.getSupportActionBar().setTitle("Test");
    ...
    public void onListItemClick(@NonNull ListView l, @NonNull View v, int position, long id) {
        ...
        Intent i = new Intent(getActivity(),FieldActivity.class);
        i.putExtras(args);
        startActivity(i);
    }
//        Fragment fragment = new FieldFragment();
